...
export const countryData = {
    ...
    georgia: {
        ...
        heroText: "STUDY",
        heroHighlight: "IN GEORGIA.",
        heroDesc: "Pursue high-quality medical education recognized globally with affordable tuition fees and a vibrant student community.",
        videoSrc: null,
        currencyIcon: <DollarSign className="w-10 h-10 text-accent-gold" />,
        currencyText: "Stay-back Visa",
        currencyValue: "1 Year",
        floatingCards: [
            { title: "WHO & NMC", subtitle: "Recognized", icon: <Stethoscope /> },
            { title: "English", subtitle: "Taught MBBS", icon: <BookOpen /> },
            { title: "No Entrance", subtitle: "Exams", icon: <CheckCircle2 /> },
            { title: "High FMGE", subtitle: "Passing Rate", icon: <ShieldCheck /> }
        ],
        opportunities: [
            { title: "Recognized Degrees", desc: "Universities recognized by WHO, NMC (MCI), FAIMER, and ECFMG.", icon: <ShieldCheck className="w-6 h-6 text-accent-gold" />, colSpan: "md:col-span-2 lg:col-span-2", bg: "bg-gradient-to-br from-accent-gold/10 to-transparent border-accent-gold/30" },
            { title: "English Taught", desc: "100% English medium instruction for international students.", icon: <BookOpen className="w-6 h-6 text-blue-400" />, colSpan: "md:col-span-1 lg:col-span-1", bg: "bg-white/5 border-white/10" },
            { title: "Affordable", desc: "Very low cost of living and reasonable tuition fees.", icon: <Coins className="w-6 h-6 text-emerald-400" />, colSpan: "md:col-span-1 lg:col-span-1", bg: "bg-white/5 border-white/10" },
            { title: "Safe Environment", desc: "Georgia is considered one of the safest countries in Europe.", icon: <HeartHandshake className="w-6 h-6 text-rose-400" />, colSpan: "md:col-span-1 lg:col-span-1", bg: "bg-white/5 border-white/10" },
            { title: "Clinical Exposure", desc: "Excellent clinical training from the early years of study.", icon: <Stethoscope className="w-6 h-6 text-indigo-400" />, colSpan: "md:col-span-2 lg:col-span-1", bg: "bg-white/5 border-white/10" }
        ],
        popularCourses: [
            { category: "Medicine", programs: ["MBBS / MD", "Dentistry", "Pharmacy"], institutions: "Tbilisi State Medical University, SEU", icon: <Stethoscope className="w-6 h-6 text-blue-400" /> }
        ],
        journeySteps: [
            { step: "01", title: "Apply", desc: "Submit 10th/12th mark sheets and NEET scorecard." },
            { step: "02", title: "Offer Letter", desc: "Receive admission offer from the university." },
            { step: "03", title: "Ministry Approval", desc: "Wait for approval from the Ministry of Education, Georgia." },
            { step: "04", title: "Visa", desc: "Apply for the Georgian Student Visa." },
            { step: "05", title: "Fly", desc: "Travel to Georgia and commence your MBBS program." }
        ],
        studyLevels: [
            {
                id: "mbbs",
                title: "MBBS (MD Program)",
                ...
                checkedInput: "checked:bg-accent-gold checked:border-accent-gold",
                eligibility: [
                    "10+2 with Physics, Chemistry, Biology (50%+).",
                    "NEET Qualified.",
                    "Age 17+ years."
                ],
                exam: "No IELTS/TOEFL. No specific university entrance exam.",
                docs: ["10th & 12th Marksheets", "NEET Scorecard", "Passport", "Birth Certificate"]
            }
        ],
        tuitionCards: [
            {
                university: "Top Medical Universities",
                description: "WHO/NMC Approved Medical Universities in Georgia.",
                rows: [
                    { year: "Tuition", tuition: "$ 4,000 - 8,000 / yr", admin: "-", total: "Varies" },
                    { year: "Living Cost", tuition: "-", admin: "-", total: "$ 3,000 - 4,000 / yr" }
                ]
            }
        ]
    },
    russia: {
        ...
        heroText: "STUDY",
        heroHighlight: "IN RUSSIA.",
        heroDesc: "Join generations of international students at highly subsidized, top-ranked government medical universities.",
        videoSrc: null,
        currencyIcon: <DollarSign className="w-10 h-10 text-accent-gold" />,
        currencyText: "Work Rights",
        currencyValue: "During Study",
        floatingCards: [
            { title: "Subsidized", subtitle: "Tuition Fees", icon: <Coins /> },
            { title: "Top Ranked", subtitle: "Medical Universities", icon: <Building2 /> },
            { title: "NMC & WHO", subtitle: "Recognized", icon: <ShieldCheck /> },
            { title: "Advanced", subtitle: "Infrastructure", icon: <Stethoscope /> }
        ],
        opportunities: [
            { title: "Subsidized Education", desc: "Government subsidized tuition makes education very affordable.", icon: <Coins className="w-6 h-6 text-accent-gold" />, colSpan: "md:col-span-2 lg:col-span-2", bg: "bg-gradient-to-br from-accent-gold/10 to-transparent border-accent-gold/30" },
            { title: "Global Recognition", desc: "Degrees are recognized by WHO, NMC, ECFMG.", icon: <ShieldCheck className="w-6 h-6 text-blue-400" />, colSpan: "md:col-span-1 lg:col-span-1", bg: "bg-white/5 border-white/10" },
            { title: "No Donations", desc: "Direct admission purely based on academic eligibility.", icon: <HeartHandshake className="w-6 h-6 text-emerald-400" />, colSpan: "md:col-span-1 lg:col-span-1", bg: "bg-white/5 border-white/10" },
            { title: "Quality Infrastructure", desc: "World-class hospitals and advanced clinical laboratories.", icon: <Building2 className="w-6 h-6 text-rose-400" />, colSpan: "md:col-span-1 lg:col-span-1", bg: "bg-white/5 border-white/10" },
            { title: "European Standard", desc: "Experience European standard of living and education.", icon: <MapPin className="w-6 h-6 text-indigo-400" />, colSpan: "md:col-span-2 lg:col-span-1", bg: "bg-white/5 border-white/10" }
        ],
        popularCourses: [
            { category: "Medicine", programs: ["MBBS / General Medicine", "Dentistry", "Nursing"], institutions: "Kazan Federal, First Moscow State", icon: <Stethoscope className="w-6 h-6 text-blue-400" /> },
            { category: "Engineering", programs: ["Aerospace", "Nuclear Engineering", "IT"], institutions: "Bauman Moscow, MEPhI", icon: <PlaneTakeoff className="w-6 h-6 text-accent-gold" /> }
        ],
        journeySteps: [
            { step: "01", title: "Apply", desc: "Submit 10th/12th mark sheets and NEET scorecard." },
            { step: "02", title: "Admission Letter", desc: "Receive the admission letter from the university." },
            { step: "03", title: "Invitation Letter", desc: "Wait for the official invitation letter from the Russian Ministry." },
            { step: "04", title: "Visa", desc: "Apply for the Russian Student Visa at VFS." },
            { step: "05", title: "Fly", desc: "Travel to Russia and start your program." }
        ],
        studyLevels: [
            {
                id: "mbbs",
                ...
                exam: "No IELTS/TOEFL. Basic entrance exam in some top universities.",
                docs: ["10th & 12th Marksheets", "NEET Scorecard", "Passport", "Medical Certificate"]
            }
        ],
        tuutuionCards: [],
        tuitionCards: [
            {
                university: "State Medical Universities",
                description: "Government recognized and subsidized medical institutions.",
                rows: [
                    { year: "Tuition", tuition: "$ 3,000 - 6,000 / yr", admin: "-", total: "Varies" },
                    { year: "Living Cost", tuition: "-", admin: "-", total: "$ 2,000 - 3,000 / yr" }
                ]
            }
        ]
    }

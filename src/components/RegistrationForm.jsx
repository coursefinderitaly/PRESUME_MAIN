...
export const RegistrationForm = () => {
  ...
  return (
    <section 
      ...
      className="section-safe relative min-h-[100svh] overflow-hidden bg-[#0a0d18] flex flex-col justify-center py-16"
    >
      ...
      {isClient && (
        <motion.div
          ...
          animate={{
            background: `radial-gradient(800px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(6,182,212,0.07), transparent 40%)`
          }}

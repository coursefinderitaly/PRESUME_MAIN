...
export const Footer = () => {
  ...
  const designerLabelSize = "0.800rem"; // equivalent to text-sm
        ...
        <div className="mt-8 flex flex-col items-center gap-4 pt-4 text-[10px] text-white/42 md:grid md:grid-cols-[1fr_auto_1fr] md:items-center md:gap-0">
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              />
              <span className="relative z-10 tracking-wider text-white/50 transition-all duration-300 group-hover:text-white group-hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]" style={{ fontFamily: "'Rosemary', cursive", fontWeight: 700, fontSize: designerLabelSize }}>
